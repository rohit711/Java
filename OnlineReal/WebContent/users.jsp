...
<form action="getAgentDetail.jsp">
<select name="name" >
<% 
System.out.println("point 1");
Query query=hibersession.getNamedQuery("getAgentnames");
System.out.println("point 2");
Iterator<AgentPojo>iter=query.list().iterator();

while(iter.hasNext())
{	
 AgentPojo objAgentPojo=iter.next();
%>
 <option value='<%=objAgentPojo.getName()%>'><br/> <%=objAgentPojo.getName().toUpperCase()%></option> 
